...
Kratki praktični vodič o tome *kako* uopće raditi s AI-jem na ovaj (agentski) način, što vam treba i koliko
košta. *(Stanje je lipanj 2026. Cijene se mijenjaju, provjerite na službenom izvoru, vidi dno.)*
...
- **Node.js 18+**, potreban za pokretanje Claude Codea (provjerite s `node --version`).
- **git**, verzioniranje (provjerite s `git --version`).
...
$200 Max 20×). Team Standard ($20/sjedalo) *ne* uključuje Claude Code, a Team Premium ($100/sjedalo,
...
Štednje su skupna obrada (*batch*) −50%, predmemorija (*cache*) −90% na ponovljeni ulaz, kontekst od 1M
tokena bez doplate. Zbog raspodjele 70/20/10 račun je **50 do 80% niži** nego da sve ide na vrhunski model.
...
*Stanje u ovom dokumentu je lipanj 2026.*
