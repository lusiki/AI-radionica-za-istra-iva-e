...
i [pojmovnik](pojmovnik.md). Engleska tehnička imena ostaju na engleskom, u zagradama: *hrvatski pojam (english-name)*.

| Materijal | Status | Što sadrži |
|---|---|---|
| [`pojmovnik.md`](pojmovnik.md) | **nacrt gotov** | 9 parova chat→agentski pojam + mali dijagram |
