...
Engleska tehnička imena ostaju na engleskom i navode se u zagradama: *hrvatski pojam (english-name)*.

| Što sad kažete (svijet chata) | Agentski pojam | Što to znači — jednostavno |
|---|---|---|
| Prompt | **specifikacija zadatka (task spec)** | Opis posla: cilj, ograničenja i kako izgleda "gotovo". Kao odjeljak o metodama, a ne nejasna molba. |
...
| "Jednostavno je to izmislio" | **halucinacija → provjera** | Rješenje nije povjerenje; to je korak koji provjerava tvrdnje/citate sa stvarnim izvorom i blokira ono što padne. |
...
— kartica "smijem li vjerovati ovom izlazu?") i `cheat-sheet.md` (3–5 agentskih obrazaca relevantnih
